...
PICS = (environ.get('PICS', 'https://i.ibb.co/S4VFhk68/IMG-20250828-105619-118.jpg')).split()  # Sample pic
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003154894065'))  # Bin channel id (make sure bot is admin)
